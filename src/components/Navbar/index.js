            ...
            <Nav>
                ...
                <div className="container" ref={this.container}>
                    <div className="btns-wrapper">
                        ...
                        <button type="button"><img src="./Empty-Cart.svg" alt=""></img><div className="cart-counter"><span>{this.props.cart.products.reduce((acc, product) => acc += product.quantity, 0)}</span></div></button>
                    </div>
